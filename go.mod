...
replace k8s.io/apimachinery => k8s.io/apimachinery v0.17.4-beta.0
...
replace k8s.io/code-generator => k8s.io/code-generator v0.17.4-beta.0

replace k8s.io/component-base => k8s.io/component-base v0.17.3

replace k8s.io/cri-api => k8s.io/cri-api v0.17.4-beta.0
